...
import { DevicePasscode } from './src/screens/auth/passcode';
import { NewWallet } from './src/screens/wallet';
import { RootSiblingParent } from 'react-native-root-siblings';
import FreeNFT from './src/screens/nft/free';
                    ...
                    <PaperProvider theme={theme}>
                        <NavigationContainer linking={linking} theme={navTheme}>
                            <Stack.Navigator initialRouteName='dashboard' screenOptions={{
                                ...
                                <Stack.Screen name={"wallet"} component={NewWallet} options={{ title: "NFT Wallet" }} />
                                <Stack.Screen name={"freeNFT"} component={FreeNFT} options={{ title: "Claim NFT" }} />
