...
export const DashboardHeader = (props: Props) => {
    ...
    return (
        <FBox style={{flexDirection: "row", padding: 18,alignItems:"center"}}>
            ...
            <FBox style={{flexDirection: "column",flex:1}}>
                <Text style={{color:"#F8F4F4",fontSize:12,fontWeight:"500"}}>{props.title}</Text>
                <FBox style={{flexDirection:"row",marginTop:2,alignItems:"center"}}>
                    ...
                    <Text style={{fontFamily: "Montserrat_700Bold"}}>{props.wallet}</Text>
                </FBox>
            </FBox>
            <FBox>
